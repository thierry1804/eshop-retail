-- Migration pour recalculer le stock de tous les produits existants

-- Supprimer les triggers et fonctions problématiques
...
-- Mettre à jour le stock de tous les produits basé sur leurs mouvements
UPDATE products 
SET 
...
-- Afficher le détail par produit
SELECT 
    p.name as produit,
    p.sku,
