-- Migration de correction pour s'assurer que la table deliveries existe avec la bonne structure

-- Vérifier et créer la table deliveries si elle n'existe pas
...
DROP POLICY IF EXISTS "Allow read access to authenticated users" ON deliveries;
DROP POLICY IF EXISTS "Allow insert to authenticated users" ON deliveries;
DROP POLICY IF EXISTS "Allow update to authenticated users" ON deliveries;
DROP POLICY IF EXISTS "Allow delete to authenticated users" ON deliveries;
